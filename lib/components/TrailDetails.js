...
class TrailDetails extends Component {
  ...
  render() {
    ...
    const trailWeather = this.props.fetchLocalWeather(currentTrailData.position);
    trailWeather.then(trailDetailWeather => {
      console.log('weather details', trailDetailWeather);
      console.log('details', trailDetailWeather.currentLocalWeather.name);
    ...
    return(
      <div className="TrailDetail">
        <section className="TitleContainer">
          ...
          <p>{trailWeather.name}</p>
          {/* <p>{trailWeather.currentLocalWeather.main.temp}</p> */}
          {/* <p>{trailWeather.currentLocalWeather.weather[0].desdescription}</p> */}

        </section>
        <div className="FullContainer">
          <section className="LeftContainer">
            <img src="./assets/mountains-card.png" alt="landscape" className="DetailImg" />
